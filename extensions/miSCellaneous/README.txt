...
======================================================================================
miSCellaneous - a library of SuperCollider extensions (c) 2009-2015 Daniel Mayer 
======================================================================================

Version 0.12a - as GUI redirect has been deprecated with SC 3.7, a-branch versions of 
...
For SC versions from 3.4 up to 3.6.x you can use 0.12b, which still gives the option of 
switching between Qt, SwingOSC and Cocoa GUI.

By version 0.12 miSCellaneous contains these class and help files 
...
5.)	Event pattern classes for parallel setting streams and effect handling
	(PmonoPar, PpolyPar).
	
6.)	Further Pattern classes (PlaceAll, Pshufn).
...
to use Qt GUI kit, which is the only option in 3.7. 
In SC 3.7 Cocoa and SwingOSC aren't supported anymore which required some
changes in miSCellaneous lib. For backward compatibility down to SC 3.4
and use with SwingOSC or Cocoa see miSCellaneous version 0.12b.
...
I tested examples on SC versions 3.5 - 3.7, 
