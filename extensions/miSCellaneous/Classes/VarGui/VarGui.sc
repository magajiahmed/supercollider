...
/*
	...
	Created: 2015-05-03, version 0.12a
	Copyright (C) 2009-2015 Daniel Mayer 
...
VarGui	{
	...
	*load_old { |pathname, filename, stream, synth, clock, quant, varEnvirGroups, envir, synthCtrGroups,
	...
	gui { |sliderHeight = 18, sliderWidth, labelWidth = 75, numberWidth = 45,
		...
		window.onClose_({
	    		#window, playerSection, colors, varCtrColorPairs, synthCtrColorPairs, synthCtrSliders, varCtrSliders, synthNameBoxes = Array.newClear(8);
	    });
